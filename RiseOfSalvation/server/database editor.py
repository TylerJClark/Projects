import sqlite3
import os
os.chdir("C:/Users/TYLER/OneDrive/Documents/python_things/real_coursework/server")
#os.chdir("F:/real_coursework/server")
...
conn.execute("INSERT INTO accounts (username,password,rating) \
      VALUES ('hello','hello',500)");
